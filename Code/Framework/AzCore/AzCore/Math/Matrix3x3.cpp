...
//cjh        void Matrix3x3ScriptConstructor(Matrix3x3* thisPtr, ScriptDataContext& dc)
//        {
...
//cjh                Attribute(AZ::Script::Attributes::ConstructorOverride, &Internal::Matrix3x3ScriptConstructor)->
...
//cjh                    Attribute(Script::Attributes::MethodOverride, &Internal::Matrix3x3MultiplyGeneric)->
...
//cjh                    Attribute(Script::Attributes::MethodOverride, &Internal::Matrix3x3DivideGeneric)->
...
//cjh                    Attribute(Script::Attributes::MethodOverride, &Internal::Matrix3x3GetBasisMultipleReturn)->
                    Attribute(Script::Attributes::ExcludeFrom, Script::Attributes::ExcludeFlags::All)->
...
//cjh                    Attribute(Script::Attributes::MethodOverride, &Internal::Matrix3x3GetRowsMultipleReturn)->
                    Attribute(Script::Attributes::ExcludeFrom, Script::Attributes::ExcludeFlags::All)->
                Method<void (Matrix3x3::*)(int, const Vector3&)>("SetRow", &Matrix3x3::SetRow)->
//cjh                    Attribute(Script::Attributes::MethodOverride, &Internal::Matrix3x3SetRowGeneric)->
                    Attribute(Script::Attributes::ExcludeFrom, Script::Attributes::ExcludeFlags::All)->
                Method("SetRows", &Matrix3x3::SetRows)->
                    Attribute(Script::Attributes::ExcludeFrom, Script::Attributes::ExcludeFlags::All)->
                Method("GetColumn", &Matrix3x3::GetColumn)->
                Method("GetColumns", &Matrix3x3::GetColumn)->
//cjh                    Attribute(Script::Attributes::MethodOverride, &Internal::Matrix3x3GetColumnsMultipleReturn)->
                    Attribute(Script::Attributes::ExcludeFrom, Script::Attributes::ExcludeFlags::All)->
                Method<void (Matrix3x3::*)(int, const Vector3&)>("SetColumn", &Matrix3x3::SetColumn)->
//cjh                    Attribute(Script::Attributes::MethodOverride, &Internal::Matrix3x3SetColumnGeneric)->
                    Attribute(Script::Attributes::ExcludeFrom, Script::Attributes::ExcludeFlags::All)->
...
//cjh                    Attribute(Script::Attributes::MethodOverride, &Internal::Matrix3x3GetPolarDecompositionMultipleReturn)->
                    Attribute(Script::Attributes::ExcludeFrom, Script::Attributes::ExcludeFlags::All)->
