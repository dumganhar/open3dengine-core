...
//cjh        void PlaneSetGeneric(Plane* thisPtr, ScriptDataContext& dc)
//        {
...
//cjh                    Attribute(AZ::Script::Attributes::MethodOverride, &Internal::PlaneSetGeneric)->
                    Attribute(AZ::Script::Attributes::ExcludeFrom, AZ::Script::Attributes::ExcludeFlags::All)->
...
//cjh                    Attribute(AZ::Script::Attributes::MethodOverride, &Internal::PlaneCastRayMultipleReturn)->
                    Attribute(AZ::Script::Attributes::ExcludeFrom, AZ::Script::Attributes::ExcludeFlags::All)->
                Method<bool(Plane::*)(const Vector3&,const Vector3&, float&) const>("IntersectSegment", &Plane::IntersectSegment)->
//cjh                    Attribute(AZ::Script::Attributes::MethodOverride, &Internal::PlaneIntersectSegmentMultipleReturn)->
                    Attribute(AZ::Script::Attributes::ExcludeFrom, AZ::Script::Attributes::ExcludeFlags::All)->
