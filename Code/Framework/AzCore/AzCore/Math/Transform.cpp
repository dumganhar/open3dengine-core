...
//cjh        void TransformSetTranslationGeneric(Transform* thisPtr, ScriptDataContext& dc)
//        {
...
//cjh    size_t TransformSerializer::Save(const void* classPtr, IO::GenericStream& stream, bool isDataBigEndian)
//    {
...
//        }
        ...
        if (behaviorContext)
        {
            ...
            //cjh                    Attribute(Script::Attributes::MethodOverride, &Internal::TransformMultiplyGeneric)->
            ...
            //cjh                    Attribute(Script::Attributes::MethodOverride, &Internal::TransformGetBasisAndTranslationMultipleReturn)->
                    Attribute(Script::Attributes::ExcludeFrom, Script::Attributes::ExcludeFlags::ListOnly)->
            ...
            //cjh                    Attribute(Script::Attributes::MethodOverride, &Internal::TransformSetTranslationGeneric)->
                    Attribute(Script::Attributes::ExcludeFrom, Script::Attributes::ExcludeFlags::ListOnly)->
