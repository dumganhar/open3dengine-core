...
//cjh        explicit Console(AZ::SettingsRegistryInterface& settingsRegistry);
        ~Console() override;
...
//cjh        void RegisterCommandInvokerWithSettingsRegistry(AZ::SettingsRegistryInterface& settingsRegistry) override;
        //! @}
...
//cjh         AZ::SettingsRegistryInterface::NotifyEventHandler m_consoleCommandKeyHandler;
