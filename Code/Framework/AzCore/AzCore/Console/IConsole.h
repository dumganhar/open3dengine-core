...
namespace AZ
{
//cjh    class SettingsRegistryInterface;
//    class CommandLine;
...
//cjh        virtual void ExecuteConfigFile(AZStd::string_view configFileName) = 0;
//
...
//cjh        virtual void RegisterCommandInvokerWithSettingsRegistry(AZ::SettingsRegistryInterface& settingsRegistry) = 0;
