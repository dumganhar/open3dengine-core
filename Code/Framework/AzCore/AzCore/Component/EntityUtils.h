...
//cjh #include <AzCore/Serialization/IdUtils.h>
...
//cjh        SerializeContext* GetApplicationSerializeContext();
//
//        /**
...
//cjh        typedef AZStd::function< void(const AZ::EntityId& /*id*/, bool /*isEntityId*/, const AZ::SerializeContext::ClassElement* /*elementData*/) > EntityIdVisitor;
//
//        /**
...
//        */
//cjh        void EnumerateEntityIds(const void* classPtr, const Uuid& classUuid, const EntityIdVisitor& visitor, SerializeContext* context = nullptr);
//
//        template<class T>
...
//cjh        using EnumerateBaseRecursiveVisitor = AZStd::function< bool(const SerializeContext::ClassData*, const Uuid&)>;
...
//cjh        bool CheckIfClassIsDeprecated(SerializeContext* context, const TypeId& typeToExamine);
//
//        //! performs a recursive search of all classes declared in the serialize hierarchy of typeToExamine
