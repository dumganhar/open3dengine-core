...
//cjh #include <AzCore/Component/EntityIdSerializer.h>
// #include <AzCore/Component/EntitySerializer.h>
#include <AzCore/Component/EntityUtils.h>
#include <AzCore/Component/ComponentApplicationBus.h>
//cjh #include <AzCore/Component/TransformBus.h>
...
namespace AZ
{
//cjh    class SerializeEntityFactory
...
//cjh    bool ConvertOldData(SerializeContext& context, SerializeContext::DataElementNode& classElement)
//    {
...
//cjh        SerializeContext* serializeContext = azrtti_cast<SerializeContext*>(reflection);
//        if (serializeContext)
//        {
...
//cjh        AZ::JsonRegistrationContext* jsonRegistration = azrtti_cast<AZ::JsonRegistrationContext*>(reflection);
//        if (jsonRegistration)
//        {
...
//cjh    AZ::TransformInterface* Entity::GetTransform() const
//    {
