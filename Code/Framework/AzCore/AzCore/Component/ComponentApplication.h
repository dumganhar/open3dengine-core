...
//cjh #include <AzCore/Module/DynamicModuleHandle.h>
...
//cjh #include <AzCore/Settings/CommandLine.h>
//cjh #include <AzCore/Settings/SettingsRegistry.h>
//cjh #include <AzCore/Settings/SettingsRegistryConsoleUtils.h>
...
namespace AZ
{
    ...
    public:
         ...
         */
        struct Descriptor
//cjh            : public SerializeContext::IObjectFactory
        {
            ...
            void* Create(const char* name);//cjh  override;
            void  Destroy(void* data);//cjh override;
            ///////////////////////////////////////////////
...
//cjh            ModuleDescriptorList m_modules;             //!< Dynamic modules used by the application.
...
//cjh            CreateStaticModulesCallback m_createStaticModulesCallback = nullptr;
...
//cjh        SerializeContext* GetSerializeContext() override;
...
//cjh        JsonRegistrationContext* GetJsonRegistrationContext() override;
        ...
        */
//cjh        AZ::CommandLine* GetAzCommandLine() override;
...
//cjh        virtual void MergeSettingsToRegistry(SettingsRegistryInterface& registry);
...
//cjh        virtual void SetSettingsRegistrySpecializations(SettingsRegistryInterface::Specializations& specializations);
...
//cjh        AZStd::unique_ptr<ModuleManager>            m_moduleManager;
...
//cjh        AZ::SettingsRegistryInterface::NotifyEventHandler m_projectPathChangedHandler;
...
//cjh        AZ::SettingsRegistryConsoleUtils::ConsoleFunctorHandle m_settingsRegistryConsoleFunctors;

#if !defined(_RELEASE)
//cjh        Debug::BudgetTracker m_budgetTracker;
#endif
...
#define AZ_MAX_PATH_LEN 1024 //cjh
        char                                        m_commandLineBuffer[AZ_MAX_PATH_LEN];
#undef AZ_MAX_PATH_LEN //cjh
        ...
        char**                                      m_argV{ nullptr };
        int                                         m_argC{ 0 };
//cjh        AZ::CommandLine                             m_commandLine; // < Stores parsed command line supplied to the constructor
