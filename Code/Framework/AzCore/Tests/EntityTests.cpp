...
//cjh #include <AzCore/Asset/AssetManager.h>
#include <AzCore/Component/Component.h>
#include <AzCore/Component/Entity.h>
//cjh #include <AzCore/Serialization/Utils.h>
...
namespace UnitTest
{
    ...
    public:
        ...
        {
//cjh            AZ::SerializeContext* serializeContext = azrtti_cast<AZ::SerializeContext*>(reflection);
//            if (serializeContext)
//            {
...
//cjh            m_sortFirstDescriptor = SortOrderTestFirstComponent::CreateDescriptor();
...
//            AZ::Entity::Reflect(m_serializeContext);
        ...
        {
//cjh            m_requiresDuplicateServiceComponentDescriptor->ReleaseDescriptor();
