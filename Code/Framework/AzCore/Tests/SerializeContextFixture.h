...
//cjh            m_serializeContext = aznew AZ::SerializeContext(true, true);
        }

        void TearDown() override
        {
//cjh            delete m_serializeContext;
//            m_serializeContext = nullptr;
    ...
    protected:
//cjh        AZ::SerializeContext* m_serializeContext = nullptr;
    };
...
//    {
//    public:
////cjh        using ReflectCallable = AZStd::function<void(AZ::SerializeContext*)>;
//
...
//
//    private:
////cjh        AZ::SerializeContext& m_serializeContext;
